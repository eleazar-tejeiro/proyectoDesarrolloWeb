...
<div class="row">
    ...
    // Obtiene calificaciones de usuarios en los cursos de profesor
    ...
    echo "<h2>Tus estudiantes de calificaciones</h2>";
    if (mysqli_num_rows($resource)<1) {
        echo "Ninguno de tus estudiantes tiene calificaciones aún";
    } else {
        echo "<table border='2'>
...
// la siguiente sección muestra estudiantes en clase sin calificaciones
    // subconsulta correlacionada para seleccionar estudiantes que no están en la tabla de calificaciones
    $sql2 = "SELECT u.nombreUsuario AS 'nombre', u.usuarioApellido AS 'apellido', c.cursoNombre AS 'curso'
			 FROM usuarios u, estudianteCurso s, curso c
    ...
    echo "<br><h2>Estudiante sin calificaciones todavía</h2>";
    if (mysqli_num_rows($resource2)<1) {
        echo "No hay otros estudiantes para mostrar";
    } else {
        echo "<table border='2'>
			<tr><th>Nombre</th><th>Apellido</th><th>Curso</th><th>Grade</th></tr>";
